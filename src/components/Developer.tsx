    ...
    If you have any questions or issues with our APIs, please feel free to contact us at any time. We are committed to providing you with the best possible experience.`}
            ...
            <motion.div
                ...
                <p>
                    ...
                    secret API keys again after you generate them.
                    <i>Do not share your API key with others.</i> You will get <b>200</b> request
                    per day with each secret key and secret key will expire after <b>1 month</b>.
                </p>
            </motion.div>
                                    ...
                                    return (
                                        <Tr
                                            ...
                                            <Td
                                                ...
                                                {key.entityId.slice(
                                                    key.entityId.length - 4,
                                                    key.entityId.length - 1
                                                )}
                                                <CopyIcon
