      ...
      <motion.div
        ...
        <Center marginY={'1rem'}>
          <Alert status="success" background={'green.600'} justifyContent={'center'} rounded={'md'}>
            ...
            information generated by the Algorithm for accurate results. To verify the availability
            of a free classroom at a specific time, simply click on the room icon to view its
            corresponding table.
          </Alert>
        </Center>
