...
export default function FreeClassRooms({ freeRooms }: { freeRooms: Array<string> }) {
      ...
      <div>
         ...
         >
            ...
            <Box marginY={'2rem'}>
               ...
               {input == "" && <Center marginTop={'1rem'} >
                  <Alert status='warning' background={'yellow.600'} justifyContent={'center'}>
                     <Icon paddingRight={'0.2rem'} fontSize={'1.5rem'}>
                        <WarningTwoIcon />
                     </Icon>
                     Free classrooms are still in preview. The information generated by ML may not be 100% accurate.
                  </Alert>
               </Center>}
            </Box>
