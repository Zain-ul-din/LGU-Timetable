                                    ...
                                    return (
                                        <React.Fragment key={idx}>
                                            {(data as Array<TimetableData>).length > 0 && (
                                                <Card
                                                    data={(data as Array<TimetableData>).sort(
                                                        (lhs, rhs) => {
                                                            return (
                                                                lhs.startTime.hours * 60 +
                                                                lhs.startTime.minutes -
                                                                (rhs.startTime.hours * 60 +
                                                                    rhs.startTime.minutes)
                                                            );
                                                        }
                                                    )}
                                                    day={day}
                        ...
                        return (
                            <Tr
                                ...
                                <Td
                                    ...
                                    fontSize={
                                        isUnder700 ? 'small' : 'inherit'
                                    }>{`${curr.startTime.hours
                                    .toString()
                                    .padStart(2, '0')}:${curr.startTime.minutes
                                    .toString()
                                    .padEnd(2, '0')} ${
                                    isUnder700 ? '\n - \n' : ' - '
                                } ${curr.endTime.hours
                                    .toString()
                                    .padStart(2, '0')}:${curr.endTime.minutes
                                    .toString()
                                    .padEnd(2, '0')}`}</Td>
                                <Td
                                    textAlign={isUnder700 ? 'center' : 'initial'}
