import { Drawer, Text, DrawerBody, DrawerContent, DrawerHeader, DrawerOverlay, Flex, useDisclosure, Button, Center } from "@chakra-ui/react";
...
)
{
    ...
    useEffect(()=> {
        ...
        if(localStorage.getItem("new_feature_promotion") == name)
            return;
    ...
    <Flex 
        ...
        position={'fixed'} 
        bottom={0} justifyContent={'center'} alignItems={'center'} width={'100%'} p={2}
        borderTop={'1px solid'} borderColor={'var(--border-color)'} bg={'var(--bg-color)'}
        zIndex={2}
    >
        <Center>

        <ViewLinkTxt href={link}>
            {name}
        </ViewLinkTxt>
        </Center>
